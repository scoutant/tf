...
public class Init implements Command {
	...
	public void execute() {
		...
		country.add( new Network("Caen", 1, 14, 13, 49.1718, -0.386) 
		.set("http://www.bison-fute.equipement.gouv.fr/asteccli/servlet/clientleger?format=png&source0=cigt_caen&source1=cir&raster=caen"));
		country.add( new Network("Toulouse", 2, 31, 13, 43.604, 1.447)
		...
		country.add( new Network("Bordeaux", 3, 33, 13, 44.8375, -0.5795)
		...
		country.add( new Network("Rennes", 4, 35, 13, 48.1086, -1.663)
		...
		country.add( new Network("Grenoble", 5, 38, 13, 45.1794, 5.7316)
		...
		country.add( new Network("Nantes", 6, 44, 13, 47.213971,-1.553593)
		.set("http://www.bison-fute.equipement.gouv.fr/asteccli/servlet/clientleger?format=png&source0=cigt_nantes&source1=cir&raster=nantes"));
		country.add( new Network("Lille", 7, 59, 12, 50.6434, 3.044)
		...
		country.add( new Network("Strasbourg", 8, 67, 13, 48.567, 7.746)
		...
		country.add( new Network("Lyon", 9, 69, 12, 45.763, 4.91)
